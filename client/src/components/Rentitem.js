...
function Rentitem (props) {
    ...
    const stateType ={"daily":"number","weekly":"number","monthly":"number","annually":"number","currency":"string","tax":"number","carId":"string"}
    ...
    const funcLoop = [setDaily,setWeekly,setMonthly,setAnnually,setCurrency,setTax,setCarId] 

    const stateObj = { daily,weekly,monthly,annually,currency,tax,carId } 
   ...
   function submitForm(e){
    ...
    function fetchData(){
        setLoading(true)
        axios.get('/rentitems', { headers: { token: localStorage.getItem('token')}})
        .then(({data}) => {
            if(data.Rentitems){
    ...
    return (
            ...
            { loading ?
                ...
                <Container fluid>
                    <div style={{ padding:'30px' }}>
                        <Row>
                            <Col>
                                <h3> <span style={{ color:'grey' }}>#</span> Rentitem </h3>
                            </Col>
        ...
        <Modal show={showModal} onHide={handleClose} size="lg">
            <Modal.Header closeButton>
                <Modal.Title>Add Rentitem </Modal.Title>
            </Modal.Header>
            <Modal.Body>
