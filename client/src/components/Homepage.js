...
export default function Homepage() {
    return (
        <div style={styles.containerHomePage}>
            <Container >
                <p style={styles.homePageSulap}> <b>Trans</b><span style={{ color:'#00b894'}}>-Pacific</span></p>
                <p style={styles.homePageSulapInfo}>Welcome to Content Management System of <span style={{ color:'#00b894', fontWeight:'bold' }}>Trans Pacific</span></p>
